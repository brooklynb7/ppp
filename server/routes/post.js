...
export default app => {
  ...
  apiRouter.post('/:id/zan', AuthController.requireAuthApi, PostController.addZan)
  apiRouter.delete('/:id/zan', AuthController.requireAuthApi, PostController.removeZan)
